...
class VdPSim
    ...
    constructor: ->
        ...
        @scopeX = new $blab.Scope
            scope : "x-scope"
            initVal : @xScale(@markerPoint.x)
            color : "green"
            yMin : -4
            yMax : 4
            margin: Figure.margin
        ...
        @scopeY = new $blab.Scope
            scope : "y-scope"
            initVal: @yScale(@markerPoint.y)
            color : "red"
            yMin : -4
            yMax : 4
            margin: Figure.margin
    ...
    snapshot2: ->
        @scopeX.draw @xScale(-1*@markerPoint.x) # ? -1 ?
        @scopeY.draw @yScale(@markerPoint.y)
